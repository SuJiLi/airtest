...
from common import check_image1,check_image2,check_zhujiemian,click_template_if_exists
...
# touch(Template(r"tpl1744773610572.png", record_pos=(-0.452, -0.85), resolution=(1080, 2220)))
# check_image1(r"tpl1760596505715.png")
# sleep(3)
# if exists(Template(r"tpl1760596571282.png")):
#     touch(Template(r"tpl1760596571282.png", record_pos=(-0.42, -0.49), resolution=(1264, 2736)))
#     check_image1(r"tpl1760596600703.png")
#     sleep(3)
#     touch(Template(r"tpl1760596809081.png", record_pos=(-0.46, -1.041), resolution=(1264, 2736)))
sleep(3)
click_template_if_exists("tpl1760597057819.png")
check_image1(r"tpl1760597119373.png")
sleep(3)
touch(Template(r"tpl1760597146788.png", record_pos=(-0.449, -1.03), resolution=(1264, 2736)))
click_template_if_exists("tpl1760599113779.png")
check_image1(r"tpl1760599143183.png")
sleep(3)
touch(Template(r"tpl1760599291220.png", record_pos=(-0.453, -1.035), resolution=(1264, 2736)))
click_template_if_exists("tpl1760599317788.png")
check_image1(r"tpl1760599635455.png")
sleep(3)
touch(Template(r"tpl1760599659858.png", record_pos=(-0.461, -1.047), resolution=(1264, 2736)))
click_template_if_exists("tpl1760599698531.png")
check_image1(r"tpl1760599970869.png")
sleep(3)
touch(Template(r"tpl1760600043686.png", record_pos=(-0.404, -0.668), resolution=(1264, 2736)))
click_template_if_exists("tpl1760601512502.png")
check_image1(r"tpl1760601610112.png")
sleep(3)
touch(Template(r"tpl1760601632464.png", record_pos=(-0.448, -1.033), resolution=(1264, 2736)))
sleep(3)
touch(Template(r"tpl1760601716696.png", record_pos=(-0.455, -1.036), resolution=(1264, 2736)))
