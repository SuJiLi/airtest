...
check_zhujiemian()
sleep(5)
if exists(Template(r"tpl1744944669943.png")):
    ...
    check_zhujiemian()
if exists(Template(r"tpl1744944889017.png")):
...
if exists(Template(r"tpl1744946291817.png")):
        ...
        sleep(1)
        if exists(Template(r"tpl1760343951426.png")):
            print("冲榜功能未解锁")
        else:
...
if exists(Template(r"tpl1744946645159.png")):
    ...
    check_zhujiemian()
if exists(Template(r"tpl1744947016683.png")):
    ...
    check_zhujiemian()
if exists(Template(r"tpl1744947083376.png")):
...
if exists(Template(r"tpl1744947786818.png")):
...
if exists(Template(r"tpl1744957972178.png")):
    ...
    check_zhujiemian()
if exists(Template(r"tpl1744958377854.png")):
