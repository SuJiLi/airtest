...
touch(Template(r"tpl1744869568363.png", record_pos=(-0.419, 0.963), resolution=(1080, 2220)))
sleep(5)
if not exists(Template(r"tpl1744869970239.png")):
    touch(Template(r"tpl1744870016123.png", record_pos=(-0.421, 0.967), resolution=(1080, 2220)))
sleep(5)
if exists(Template(r"tpl1744870041029.png")):
    ...
    check_zhujiemian()
sleep(5)
if exists(Template(r"tpl1744870127601.png")):
    ...
    check_zhujiemian()
    sleep(5)
if exists(Template(r"tpl1744870887785.png")):
    ...
    sleep(5)
    touch(Template(r"tpl1744872025786.png", threshold=0.6, record_pos=(-0.441, -0.86), resolution=(1080, 2220)))
    sleep(5)
    check_zhujiemian()
    sleep(5)
if exists(Template(r"tpl1744873064643.png")):
        touch(Template(r"tpl1744873064643.png", record_pos=(-0.416, 0.26), resolution=(1080, 2220)))
        check_image1(r"tpl1744873153265.png")
        sleep(80)
        sleep(5)
if exists(Template(r"tpl1744873322640.png")):
    ...
    if exists(Template(r"tpl1744873343758.png")):
        ...
        touch(Template(r"tpl1760581532923.png", record_pos=(-0.456, -0.307), resolution=(1264, 2736)))
if exists(Template(r"tpl1744873733101.png")):
    ...
    check_zhujiemian()
if exists(Template(r"tpl1744874223614.png")):
    ...
    check_zhujiemian()
    sleep(5)
if exists(Template(r"tpl1744873262934.png")):
