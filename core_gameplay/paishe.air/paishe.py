...
sleep(3)
touch(Template(r"tpl1744602387131.png", threshold=0.5, record_pos=(-0.369, -0.322), resolution=(1080, 2220)))
sleep(10)
try:
    if exists(Template(r"tpl1744624183960.png", threshold=0.6)):
        sleep(3)
        touch((335,357))
...
if exists(Template(r"tpl1744788511633.png", threshold=0.9)):
    touch(Template(r"tpl1744788528964.png", record_pos=(-0.002, 0.244), resolution=(1080, 2220)))
